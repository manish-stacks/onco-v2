...
import { getBrandById, getRelatedMedicines } from "@/lib/data";
...
export function ProductDetail({ medicine }: { medicine: Medicine }) {
  ...
  const brand = getBrandById(medicine.brandId);
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
        ...
        {/* Info */}
        <div>
          <p className="mb-1 text-sm font-medium text-[var(--blue-600)]">{brand?.name}</p>
