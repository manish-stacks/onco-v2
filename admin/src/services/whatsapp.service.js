...
const TEMPLATES = {
  ...
  // Customer ko — shipped MANUALLY (Porter / local rider / hand delivery).
  // No live tracking link exists for these, so this is a separate template —
  // register it on your WhatsApp Business template manager before use.
  ORDER_SHIPPED_MANUAL: {
    name: 'order_shipped_manual',
    params: ['customer_name', 'order_id', 'courier', 'awb'],
  },
